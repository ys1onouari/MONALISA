...
INSERT INTO menu_items (name, category_id, price, description, available, popular) VALUES
  ...
  ('{"fr":"Mixed Grill CHEF HAM&HAM","en":"Mixed Grill CHEF HAM&HAM","es":"Mixed Grill CHEF HAM&HAM"}', 5, 58, '{"fr":"Sélection de viandes grillées : bœuf, agneau, poulet, merguez maison.","en":"Selection of grilled meats: beef, lamb, chicken, homemade merguez.","es":"Selección de carnes a la parrilla: ternera, cordero, pollo, merguez casero."}',                                     TRUE,  TRUE),
...
INSERT INTO settings (key, value) VALUES
   ('restaurant_name',     '{"fr":"RESTAURANT CHEF HAM&HAM","en":"RESTAURANT CHEF HAM&HAM","es":"RESTAURANT CHEF HAM&HAM"}'),
